...

{
    ...
    "category": "function",
    "text": "genskypointings(t_start, t_stop, dirs; latitude_deg=0.0, longitude_deg=0.0, \n                height_m=0.0)\n\nProject a set of pointings in the sky.  \n\nThe parameter t_start and t_start must be two DateTime which tell the exact  UTC date and time of the observation. The parameter dirs must  be a N×2 array  containing the observed directions expressed in colatitude and the longitude. The keywords latitude_deg, longitude_deg and height_m should contain the  latitude (in degrees, N is positive), the longitude (in degrees, counterclockwise is positive) and the height (in meters)  of the location where the observation is made.\n\nReturn a 2-tuple containing the observed directions projected in sky coordinates  (a N×2 array containing the Right ascension and the Declination, in radians) at  each time step.  Directions are expressed in equatorial coordinates.\n\nExample:\n\ngenskypointings(DateTime(2019, 01, 01, 0, 0, 0), \n                DateTime(2022, 04, 13, 21, 10, 10), \n                dirs)\n\n\n\n\n\n"
},
