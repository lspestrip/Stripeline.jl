...
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), 0), 0, tel_ang = TelescopeAngles(), cam_ang = CameraAngles()), 
                [0.9396926207859084 0.0 0.3420201433256687; 0.0 1.0 0.0; -0.3420201433256687 0.0 0.9396926207859084])
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), 0), 0, tel_ang = TelescopeAngles(forkang_rad=deg2rad(10))),
...
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), 0), 0, tel_ang = TelescopeAngles(wheel2ang_0_rad=deg2rad(10))), 
                [0.984807753012208 0.0 0.17364817766693033; 0.0 1.0 0.0; -0.17364817766693033 0.0 0.984807753012208])
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), 0), 0, tel_ang = TelescopeAngles(wheel3ang_0_rad=deg2rad(-10))), 
...
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), 0), 0, tel_ang = TelescopeAngles(zVAXang_rad=deg2rad(10))), 
                [0.9396926207859084 0.0 0.3420201433256687; 0.0593911746138847 0.984807753012208 -0.16317591116653482; -0.33682408883346515 0.17364817766693033 0.9254165783983234])
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), 0), 0, tel_ang = TelescopeAngles(omegaVAXang_rad=deg2rad(10))), 
                [0.9254165783983234 -0.17364817766693033 0.33682408883346515; 0.16317591116653482 0.984807753012208 0.0593911746138847; -0.3420201433256687 0.0 0.9396926207859084])
@test isapprox(angletomatrix(_ -> (0, deg2rad(20.0), deg2rad(-30.0)), 0, cam_ang = CameraAngles(rollang_rad=deg2rad(45))),
...
@test isapprox(angletomatrix(_ -> (0, deg2rad(20.0), deg2rad(-30.0)), 0, cam_ang = CameraAngles(panang_rad=deg2rad(25))),
...
@test isapprox(angletomatrix(_ -> (0, deg2rad(20.0), deg2rad(-30.0)), 0, cam_ang = CameraAngles(tiltang_rad=deg2rad(10))),
...
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), 0), 0, tel_ang = TelescopeAngles(wheel2ang_0_rad=deg2rad(48), wheel3ang_0_rad=deg2rad(-30))), 
...
@test isapprox(angletomatrix(_ -> (0.0, deg2rad(20.0), deg2rad(-30.0)), 0, tel_ang = TelescopeAngles(wheel2ang_0_rad=deg2rad(48), wheel3ang_0_rad=deg2rad(-30), forkang_rad=deg2rad(52))),
...
@test isapprox(angletomatrix(_ -> (0, deg2rad(20.0), deg2rad(-30.0)), 0, tel_ang = TelescopeAngles(wheel2ang_0_rad=deg2rad(48.),wheel3ang_0_rad=deg2rad(-30.),forkang_rad=deg2rad(52.),zVAXang_rad=deg2rad(42.))),
...
@test isapprox(angletomatrix(_ -> (0, deg2rad(20.0), deg2rad(-30.0)), 0, tel_ang = TelescopeAngles(wheel2ang_0_rad=deg2rad(48.),wheel3ang_0_rad=deg2rad(-30.),forkang_rad=deg2rad(52.),zVAXang_rad=deg2rad(42.),omegaVAXang_rad=deg2rad(73.))),
...
@test isapprox(angletomatrix(_ -> (0, deg2rad(20.0), deg2rad(-30.0)), 0, cam_ang = CameraAngles(rollang_rad=deg2rad(68),tiltang_rad=deg2rad(91),panang_rad=deg2rad(137))),
...
@test isapprox(angletomatrix(_ -> (0, deg2rad(20.0), deg2rad(-30.0)), 0, tel_ang = TelescopeAngles(wheel2ang_0_rad=deg2rad(48.),wheel3ang_0_rad=deg2rad(-30.),forkang_rad=deg2rad(52.),zVAXang_rad=deg2rad(42.),omegaVAXang_rad=deg2rad(73.)), cam_ang = CameraAngles(rollang_rad=deg2rad(26),panang_rad=deg2rad(33),tiltang_rad=deg2rad(79))),
